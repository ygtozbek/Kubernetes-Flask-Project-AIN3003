📚 AIN-3003 Project : Kubernetes Bookstore API
...
Build the Docker Image: docker build -t python-app:v1 .

Deploy MongoDB (StatefulSet): kubectl apply -f mongodb.yaml

Deploy the Flask App: kubectl apply -f flask_app.yaml

Test it: Go to http://localhost:5000/books in your browser to see the book list!
